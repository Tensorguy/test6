...
$("#button1").on('click', function(e){
    socket.emit('button1 click', {value: 0, userId: userId});
});
$("#button2").on('click', function(e){
    socket.emit('button2 click', {value: 0, userId: userId});
});
$("#button3").on('click', function(e){
    socket.emit('button3 click', {value: 0, userId: userId});
});
...
socket.on('toogle led', function(msg) {
    if(msg.value === false) {
        ...
        $("#led-container span").text("FARTING");
    }
});
